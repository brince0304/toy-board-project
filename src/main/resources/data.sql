insert into SAVE_FILE (CREATED_AT, CREATED_BY, MODIFIED_AT, MODIFIED_BY, FILE_NAME, FILE_PATH, FILE_SIZE, FILE_TYPE, UPLOAD_USER) VALUES ( now(), 'test', now(), 'test', 'default.jpg', '/Users/brinc/Desktop/brincestudy/fastcampus-project-board/src/main/resources/static/images/default.jpg', 0, '.jpg', 'test');
